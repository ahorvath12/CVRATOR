...
public class PlayerStateMenu : PlayerState
{
    ...
    private int timesPressed = 0;           // Tracks number of times thumbstick is pressed

    private bool openPocket = false;      // Tracks when the pocket inventory should be opened

    public PlayerStateMenu(StateData init_data) : base(init_data) {; }
